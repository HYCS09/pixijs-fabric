...
export class Point implements XY {
   ...
   */
  add(that: XY): Point {
    temp2.setXY(this.x + that.x, this.y + that.y);
    return temp2;
  }
  ...
  scalarAdd(scalar: number): Point {
    temp3.setXY(this.x + scalar, this.y + scalar);
    return temp3;
  }
  ...
  subtract(that: XY): Point {
    temp4.setXY(this.x - that.x, this.y - that.y);
    return temp4;
  }
  ...
  scalarSubtract(scalar: number): Point {
    temp5.setXY(this.x - scalar, this.y - scalar);
    return temp5;
  }
  ...
  multiply(that: XY): Point {
    temp6.setXY(this.x * that.x, this.y * that.y);
    return temp6;
  }
  ...
  scalarMultiply(scalar: number): Point {
    temp7.setXY(this.x * scalar, this.y * scalar);
    return temp7;
  }
  ...
  divide(that: XY): Point {
    temp8.setXY(this.x / that.x, this.y / that.y);
    return temp8;
  }
  ...
  scalarDivide(scalar: number): Point {
    temp9.setXY(this.x / scalar, this.y / scalar);
    return temp9;
  }
   ...
   */
  min(that: XY): Point {
    temp11.setXY(Math.min(this.x, that.x), Math.min(this.y, that.y));
    return temp11;
  }
   ...
   */
  max(that: XY): Point {
    temp12.setXY(Math.max(this.x, that.x), Math.max(this.y, that.y));
    return temp12;
  }
   ...
   */
  rotate(radians: number, origin: XY = ZERO): Point {
    // TODO benchmark and verify the add and subtract how much cost
    // and then in case early return if no origin is passed
    const sinus = sin(radians),
      cosinus = cos(radians);
    const p = this.subtract(origin);
    temp0.setXY(p.x * cosinus - p.y * sinus, p.x * sinus + p.y * cosinus);
    return temp0.add(origin);
  }
...
const temp0 = new Point();
const temp1 = new Point();
const temp2 = new Point();
const temp3 = new Point();
const temp4 = new Point();
const temp5 = new Point();
const temp6 = new Point();
const temp7 = new Point();
const temp8 = new Point();
const temp9 = new Point();
const temp10 = new Point();
const temp11 = new Point();
const temp12 = new Point();
