...
import { pickBy, pick } from './support';

export type CompleteTextStyleDeclaration = Pick<
  FabricText,
  Extract<StylePropertiesType, keyof FabricText>
>;
...
export abstract class StyledText extends FabricObject {
  ...
  getCompleteStyleDeclaration(
    ...
    const styleProps = (this.constructor as unknown as typeof StyledText)
      ._styleProperties as (keyof this)[];
    return {
      ...pick(this, styleProps),
      ...this._getStyleDeclaration(lineIndex, charIndex),
